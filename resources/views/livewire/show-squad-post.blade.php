...
<div class="flex flex-col items-center">
    ...
    <div id="deleteModal"
        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <h2 class="text-lg font-bold mt-2 text-center">¿Estás seguro de querer eliminar esta publicación?</h2>
                        ...
                        <div
                            ...
                            <div class="flex flex-row">
                                ...
                                <div class="min-w-lg">
                                    ...
                                    <span class="text-sm font-bold"> {{ $comment->created_at->diffForHumans() }}</span>
