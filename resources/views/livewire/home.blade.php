...
<div class="container px-6 mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="md:col-span-3 md:col-start-2">
            @if ($posts->count() > 0)
                <div class="grid gap-6 my-8 md:grid-cols-1 lg:grid-cols-2">
            ...
            @else
                <div class="flex flex-col items-center justify-center h-160">
                    ...
                    <div class="text-center mt-6">
                        ...
                        <p class="text-gray-500 dark:text-gray-300 mt-2">No hay publicaciones. Por favor, vuelva más tarde.</p>
                    </div>
                </div>
            @endif
        </div>
