        ...
        <div class="container px-10 mx-auto mt-10">
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                @foreach ($banned_users as $user)
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-sm">{{ $user->banned_at }}</td>
                                        <td class="px-4 py-3 text-sm">{{ $user->banned_to }}</td>
                                        <td class="px-4 py-3 text-xs">{{ $user->is_banned }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a href="{{ route('all-users') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center">
                        Gestionar Usuarios
                    </a>
                </div>
            </div>
