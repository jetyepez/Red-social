...
<div id="accountDelete"
    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <h2 class="text-lg font-bold mt-2 text-center">¿Estás seguro de eliminar <span
                id="modal-title">{{ auth()->user()->username }}</span>?</h2>
        <span class="text-sm font-bold my-4">Para confirmar, escribe "{{ auth()->user()->username }}" en el cuadro
            de abajo</span>
